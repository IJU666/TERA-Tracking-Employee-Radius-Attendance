  ...
  import 'dart:convert'; // Tambahkan ini di baris paling atas dokumen
...
Widget _profileCard(
    ...
    // Logic untuk menentukan jenis gambar (URL internet atau teks Base64)
          ...
          Stack(
            children: [
              CircleAvatar(
                ...
                backgroundImage: avatarProvider, // Pakai provider yang sudah difilter
