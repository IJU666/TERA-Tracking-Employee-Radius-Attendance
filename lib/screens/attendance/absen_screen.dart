...
// Mengasumsikan import sesuai struktur folder kamu:
...
class _AbsenScreenState extends State<AbsenScreen> {
  ...
  // Titik kantor tetap (nanti bisa diambil dari OfficeProvider)
  final LatLng _officeLocation = const LatLng(-6.9140, 107.6090);
  final double _officeRadius = 50.0; // dalam meter

  // Lokasi user: null di awal karena belum ada data GPS
  ...
  void initState() {
    super.initState();
    // Ambil lokasi user otomatis begitu halaman dibuka
    _refreshLocation();
  }
  ...
  Future<void> _refreshLocation() async {
    ...
    try {
      // Cek dulu apakah GPS device aktif
      ...
      // Pindahkan kamera peta ke posisi user yang baru didapat
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. Peta OpenStreetMap — center awal di kantor, nanti pindah ke user
          Positioned(
            top: 0,
            left: 0,
            right: 0,
            ...
            child: Stack(
              children: [
                    ...
                    MarkerLayer(
                      markers: [
                        Marker(
                          ...
                          width: 40,
                          height: 40,
                          child: const Icon(Icons.location_city, color: Colors.red, size: 36),
                        ),
                        if (hasLocation)
                          Marker(
                ...
                // Loading overlay saat GPS sedang dicari
                if (_isLoading)
                  Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Tampilkan pesan error kalau GPS gagal
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: (hasLocation && isWithinRadius) ? _submitAttendance : null,
